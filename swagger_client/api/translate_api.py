...
class TranslateApi(object):
    ...
    def translate(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.translate(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param Question body: Question object that needs to be translated (required)
        :return: list[Query]
    ...
    def translate_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.translate_with_http_info(body, async=True)
        >>> result = thread.get()
